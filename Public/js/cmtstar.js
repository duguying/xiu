...
function tpc_detail(id,title){
	...
	var hstr='<div id="tpc_frame"><span class="tpc_title">主题：'+tpc_name+'<div id="tbtn">X</div></span><iframe id="page" allowtransparency="false" src="'+U('tpcdetail/tpc/'+tpc_id)+'"  frameborder="0" marginwidth="0" marginheight="0" scrolling="auto" ></iframe></div>'
	$("#tpc_frame").remove();
	$("body").append(hstr);
	$("#tpc_frame").draggable();
